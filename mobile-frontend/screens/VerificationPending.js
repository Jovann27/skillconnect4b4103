      ...
      <View style={styles.content}>
        ...
        <View style={styles.detailsContainer}>
          <View style={styles.detailItem}>
            ...
            <Text style={styles.detailText}>Check your email for verification updates</Text>
          </View>
          <View style={styles.detailItem}>
            <Text style={styles.detailIcon}>🛡️</Text>
            <Text style={styles.detailText}>Verification typically takes 1-3 business days</Text>
          </View>
          <View style={styles.detailItem}>
            <Text style={styles.detailIcon}>📞</Text>
            <Text style={styles.detailText}>Contact support if you have questions</Text>
          </View>
        </View>
